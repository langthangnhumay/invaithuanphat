<?php
/*
  Plugin Name: PPO Call To Actions Pro
    ...
    public function add_buttons() {
        ...
        if($active){
            ...
            <div id="messengerButton">
                <a rel="nofollow noopener" href="http://fb.com/msg/{$messenger}" target="_blank" class="ppocta-btn-messenger-tracking"><i></i></a>
            </div>
HTML;
            }
            if(intval($show_zalo) == 1){
                echo <<<HTML
            <div id="zaloButton">
                <a rel="nofollow noopener" href="http://zalo.me/{$zalo}" target="_blank" class="ppocta-btn-zalo-tracking"><i></i></a>
            </div>
HTML;
            }
